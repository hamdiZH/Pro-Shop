...
import {FlexColumn, InnerSection, SpinnerContainer, Typography} from "../../../App.Styles";
...
function Orders(props) {
    ...
    return isLoading? (
        ...
        <InnerSection style={{ margin: "44px 0 60px", alignItems: "flex-start" }}>
            <Typography style={{ justifyContent: "start" }} fontSize="32" color="#242424" fontWeight="700">
                MY ORDERS
            </Typography>
            <FlexColumn>
                <ListBox>
